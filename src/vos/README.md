...
There is available a tool to estimate the metadata overhead. It is described on the <a href="https://github.com/daos-stack/daos/blob/master/src/client/scm_estimator/README.md">scm_estimator</a> section.
